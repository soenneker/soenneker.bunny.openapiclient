...
using System;
namespace Soenneker.Bunny.OpenApiClient.MagicContainers.Apps.Item.Undeploy
{
    /// <summary>
    /// Builds and executes requests for operations under \magic-containers\apps\{appId}\undeploy
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class UndeployRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bunny.OpenApiClient.MagicContainers.Apps.Item.Undeploy.UndeployRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UndeployRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/magic-containers/apps/{appId}/undeploy", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bunny.OpenApiClient.MagicContainers.Apps.Item.Undeploy.UndeployRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UndeployRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/magic-containers/apps/{appId}/undeploy", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bunny.OpenApiClient.MagicContainers.Apps.Item.Undeploy.UndeployRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bunny.OpenApiClient.MagicContainers.Apps.Item.Undeploy.UndeployRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bunny.OpenApiClient.MagicContainers.Apps.Item.Undeploy.UndeployRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
