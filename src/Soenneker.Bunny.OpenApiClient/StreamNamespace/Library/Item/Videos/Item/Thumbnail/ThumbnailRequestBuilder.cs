...
using System;
namespace Soenneker.Bunny.OpenApiClient.StreamNamespace.Library.Item.Videos.Item.Thumbnail
{
    /// <summary>
    /// Builds and executes requests for operations under \stream\library\{libraryId}\videos\{videoId}\thumbnail
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ThumbnailRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bunny.OpenApiClient.StreamNamespace.Library.Item.Videos.Item.Thumbnail.ThumbnailRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ThumbnailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stream/library/{libraryId}/videos/{videoId}/thumbnail{?thumbnailUrl*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bunny.OpenApiClient.StreamNamespace.Library.Item.Videos.Item.Thumbnail.ThumbnailRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ThumbnailRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stream/library/{libraryId}/videos/{videoId}/thumbnail{?thumbnailUrl*}", rawUrl)
        {
        }
        /// <summary>
        /// Set Thumbnail
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Stream body, Action<RequestConfiguration<global::Soenneker.Bunny.OpenApiClient.StreamNamespace.Library.Item.Videos.Item.Thumbnail.ThumbnailRequestBuilder.ThumbnailRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Stream body, Action<RequestConfiguration<global::Soenneker.Bunny.OpenApiClient.StreamNamespace.Library.Item.Videos.Item.Thumbnail.ThumbnailRequestBuilder.ThumbnailRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bunny.OpenApiClient.StreamNamespace.Library.Item.Videos.Item.Thumbnail.ThumbnailRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bunny.OpenApiClient.StreamNamespace.Library.Item.Videos.Item.Thumbnail.ThumbnailRequestBuilder WithUrl(string rawUrl)
        {
